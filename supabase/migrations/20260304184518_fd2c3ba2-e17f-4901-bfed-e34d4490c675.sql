...
-- Drop existing restrictive policies on ai_suggestions
...
-- Recreate with broader agent access (include agents from same department for unassigned conversations)
